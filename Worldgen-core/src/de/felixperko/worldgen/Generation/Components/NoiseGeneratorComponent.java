...
public class NoiseGeneratorComponent extends Component{
	...
	public static HashMap<String, NoiseGeneratorMethod> optionMethods = new HashMap<>();
	
	static {
		
	}
	
	@OptionsComponentSetting(options = {"normal","billowed","ridged","iq","mountains","erodedMountains"}, reloadSettings = true)
	public String noisetype = "normal";
